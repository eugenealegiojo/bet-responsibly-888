...
! ( function ( t, e ) {
	...
	var ye = function ( t ) {
		...
		Ae = function ( t, e, n, o, i ) {
			Pt &&
				( ( g.swalCloseEventFinishedCallback = he.bind(
					null,
					t,
					n,
					o,
	...
	var Bn,
		...
		Vn = function ( t ) {
			...
			Array.from( t.children ).forEach( function ( t ) {
				...
				e.includes( n ) ||
					E( 'Unrecognized element <'.concat( n, '>' ) );
			} );
		},
		_n = function ( t, e ) {
	...
	var Yn = new WeakMap(),
		...
		Qn = function ( t, e ) {
			e.toast ||
				( x( e.allowEnterKey ) ? to( t, e ) || Gt( -1, 1 ) : eo() );
		},
		to = function ( t, e ) {
